    ...
    <>
      ...
      <div class="flex mb-5">
        <div class="flex items-center me-4">
          ...
          <label htmlFor="inline-radio" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Venta</label>
        </div>
        <div class="flex items-center me-4">
          ...
          <label htmlFor="inline-2-radio" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Renta</label>
        </div>
      </div>
