...
const { autorizarPost, rechazarPost, asignarVendedor } = require('../controllers/posts/admin');
...
router.put('/post/:id/vendedor', validarJWT, buscarVendedor);

// ADMIN
router.put('/post/:id/autorizar', validarJWT, autorizarPost);
router.put('/post/:id/rechazar', validarJWT, rechazarPost);
router.put('/post/:id/asginar', validarJWT, asignarVendedor)
